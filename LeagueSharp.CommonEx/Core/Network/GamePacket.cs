...
namespace LeagueSharp.CommonEx.Core.Network
{
    ...
    public sealed class GamePacket : IDisposable
    {
        ...
        ///     Game Packet Data
        /// </summary>
        private readonly GamePacketData _packetData;
        ...
        {
            _packetData = new GamePacketData(data);
        }
        ...
        {
            _packetData = new GamePacketData(args);
        ...
        {
            _packetData = new GamePacketData(packet.Id);
        ...
        {
            _packetData = new GamePacketData(id);
            Channel = channel;
            Flags = flags;
        }
        ...
        {
            get { return _packetData.GetPacketId(); }
        }
        ...
        {
            get { return _packetData.Writer; }
        }

        private BinaryReader Reader
        {
            get { return _packetData.Reader; }
        }
        ...
        {
            get { return _packetData.PacketData; }
        }
    ...
    internal sealed class GamePacketData : IDisposable
    {
        ...
        {
            _ms = data == null ? new MemoryStream() : new MemoryStream(data);
            Reader = new BinaryReader(_ms);
